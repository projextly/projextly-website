...
export function Card2() {
  return (
    <section className="flex w-[88vw] shrink-0 items-center justify-center rounded-[2.5rem] bg-[#444645] border border-[#E8F4F0]/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] sm:w-[85vw] md:w-[80vw] lg:w-[70vw] xl:w-[1100px] overflow-hidden relative">
